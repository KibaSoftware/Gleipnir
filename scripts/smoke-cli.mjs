...
if (version !== "0.7.4") {
  throw new Error(`Expected Gleip 0.7.4, received: ${version}`);
}

if (report.schemaVersion !== "1.0.0" || report.version !== "0.7.4") {
  throw new Error(`Expected Gleip 0.7.4 report schema 1.0.0, received:\n${reportJson}`);
}
