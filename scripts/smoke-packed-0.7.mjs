...
const tarball = join(root, "gleip-0.7.1.tgz");
...
assertEqual(runGleip(["--version"], repo).trim(), "0.7.1", "packed version");
runGleip(["init"], repo);
...
console.log(`Packed Gleip 0.7.1 smoke test passed in ${repo}`);
