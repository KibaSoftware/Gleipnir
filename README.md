...
- `fail`: strong local finding, non-blocking in 0.5.0 CI
...
`SCOPE_EXPANSION_WARN`, `PLAN_TOO_VAGUE`, and `MISSING_TEST_STRATEGY`.
...
and scope-expansion findings do not block CI in 0.5.0.
...
Gleip 0.5.0 generates two local report artifacts:
